	...
	private void initData() {
		...
		for ( int i = 0; i < integers.length; i++ ) {
			...
			bulkIndexer.add( id, document -> {
				...
				document.addValue( mainIndex.binding().doubleF, value == null ? null : value.doubleValue() );
				document.addValue( mainIndex.binding().floatF, value == null ? null : value.floatValue() );

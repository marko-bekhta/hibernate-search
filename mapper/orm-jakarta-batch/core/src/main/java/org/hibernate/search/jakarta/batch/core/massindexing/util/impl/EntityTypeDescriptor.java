...
import org.hibernate.search.jakarta.batch.core.massindexing.loading.impl.DefaultHibernateOrmBatchLoadingStrategy;
...
public class EntityTypeDescriptor<E, I> implements HibernateOrmBatchLoadingTypeContext<E> {
	...
	public static <E> EntityTypeDescriptor<E, ?> create(SessionFactoryImplementor sessionFactory,
		...
		if ( batchLoadingStrategy == null ) {
			batchLoadingStrategy = new DefaultHibernateOrmBatchLoadingStrategy<>( type );
		}
		return new EntityTypeDescriptor<>( type, batchLoadingStrategy );
	}
	...
	public EntityTypeDescriptor(HibernateOrmLoadingTypeContext<E> delegate,

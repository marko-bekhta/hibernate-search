...
public class ElasticsearchDialectsTest {
	...
	@MethodSource("params")
	public void isPreciseEnoughForBootstrap(ElasticsearchVersion version, boolean isPreciseEnoughForBootstrap,
	...
	@ParameterizedTest(name = "{0}")
	@MethodSource("params")
	public void isPreciseEnoughForStart(ElasticsearchVersion version, boolean isPreciseEnoughForBootstrap,
			boolean isPreciseEnoughForStart, boolean isVersionCheckImpossible) {
	...
	@ParameterizedTest(name = "{0}")
	@MethodSource("params")
	public void isVersionCheckImpossible(ElasticsearchVersion version, boolean isPreciseEnoughForBootstrap,
			boolean isPreciseEnoughForStart, boolean isVersionCheckImpossible) {
